...
var initBrandsCarousel = function initBrandsCarousel() {
  var section = document.querySelector('[data-brands-slider]');
  if (!section) return null;
  var container = section.querySelector('.swiper');
  var paginationEl = section.querySelector('.brands-carousel__pagination');
  var nextEl = section.querySelector('.brands-carousel__nav--next');
  var prevEl = section.querySelector('.brands-carousel__nav--prev');
  var navStack = section.querySelector('.brands-carousel__nav-stack');
  ...
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](container, {
    ...
    navigation: hasMultipleSlides && nextEl && prevEl ? {
      nextEl: nextEl,
      prevEl: prevEl
    } : false,
    breakpoints: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initBrandsCarousel);
...
/* harmony import */ var _pages_brands__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/brands */ "./src/js/pages/brands.js");


document.addEventListener('DOMContentLoaded', function () {
  (0,_pages_brands__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
})();
